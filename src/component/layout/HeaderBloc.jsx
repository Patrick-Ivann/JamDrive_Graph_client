...
import { LOCAL_THEMESTORE_QUERY, LOCAL_USERSTORE_QUERY } from '../../graphql/local/localQueries';
...
export default function HeaderBloc() {
    ...
    const { client: localUserClient,
        ...
        localClient: localUserCalled } = useQuery(LOCAL_USERSTORE_QUERY);

    return (
        <div>
            {userStore && <Header themeStore={themeStore} ></Header>}
        </div>
    )
}
